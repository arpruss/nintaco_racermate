...
public class DongdaPEC586KeyboardDescriptor extends DeviceDescriptor {
  ...
  @Override public int getButtonCount() {
    return 98;
  }
  
  @Override public int getRewindTimeButton() {
    return RewindTime;
  }  

  @Override public String getButtonName(final int buttonIndex) {
    return NAMES[buttonIndex];
  }

  @Override public ButtonMapping getDefaultButtonMapping(final int buttonIndex){    
  ...
  @Override public int setButtonBits(int bits, final int consoleType, 
