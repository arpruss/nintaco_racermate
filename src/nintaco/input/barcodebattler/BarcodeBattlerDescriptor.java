...
public class BarcodeBattlerDescriptor extends DeviceDescriptor {

  public static final int RewindTime = 0;
  
  private static final Key[] DEFAULTS = { EQUALS, };
  
  public BarcodeBattlerDescriptor() {
    super(InputDevices.BarcodeBattler);
  }
  
  @Override
  public String getDeviceName() {
    return "Barcode Battler II";
  }
