...
public class FileDrop {
      ...
      dropListener = new java.awt.dnd.DropTargetListener() {
        ...
        public void drop(java.awt.dnd.DropTargetDropEvent evt) {
          ...
          try {   // Get whatever was dropped
            ...
            // Is it a file list?
            if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor
                .javaFileListFlavor)) {
              // Say we'll take it.
            ...
            else // this section will check for a reader flavor.
            {
              ...
              for (int zz = 0; zz < flavors.length; zz++) {
                if (flavors[zz].isRepresentationClassReader()) {
                  // Say we'll take it.
                  //evt.acceptDrop(ACTION_COPY_OR_MOVE);
                  evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
        ...
        public void dropActionChanged(java.awt.dnd.DropTargetDragEvent evt) {
          ...
          // Is this an acceptable drag event?
          if (isDragOk(out, evt)) {   //evt.acceptDrag(ACTION_COPY_OR_MOVE );
            evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_COPY);
            log(out, "FileDrop: event accepted.");
          } // end if: drag ok
          else {
   ...
   * example your class declaration may begin like this:    <pre>
   ...
   * {@link Listener#filesDropped(java.io.File[])  filesDropped(...)} method in your
  ...
  public static class TransferableObject 
    ...
    public final static java.awt.datatransfer.DataFlavor DATA_FLAVOR
        = new java.awt.datatransfer.DataFlavor(FileDrop.TransferableObject
            .class, MIME_TYPE);
