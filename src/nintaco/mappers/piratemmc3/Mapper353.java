...
public class Mapper353 extends MMC3 {
  ...
  @Override public void writeMemory(final int address, int value) {   
  ...
  @Override protected void updateChrBanks() {
  ...
  @Override public void setNametable(final int index, final int value) {
