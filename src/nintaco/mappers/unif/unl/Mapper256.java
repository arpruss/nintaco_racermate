...
public class Mapper256 extends OneBus {
  ...
  @Override protected void write2(int address, final int value) {
  ...
  @Override protected void write4(int address, final int value) {
  ...
  @Override protected void writeMMC3(final int address, int value) {
