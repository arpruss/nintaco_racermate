...
public class COOLGIRL extends Mapper {
  ...
  @Override protected void setChrBank(final int bank, final int value) {
  ...
  @Override public int readMemory(final int address) {    
  ...
  @Override public void writeRegister(final int address, final int value) {
  ...
  @Override public void writeMemory(final int address, final int value) {    
  ...
  @Override public void writeVRAM(final int address, final int value) {
    if (address < 0x2000) {
  ...
  @Override public void handlePpuCycle(final int scanline, 
  ...
  @Override public void readTransients(final DataInput in) throws IOException {
    super.readTransients(in);
    loadFlash();    
  }  
  
  @Override protected void saveNonVolatilePrgRam() {
    synchronized(GamePrefs.class) {
